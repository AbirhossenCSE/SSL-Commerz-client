    ...
    return (
        <div>
            ...
            <div className="max-w-5xl mx-auto px-6 py-10">
                ...
                <div className="bg-base-300 shadow-lg rounded-lg border border-base-200 p-8 flex flex-col md:flex-row items-center md:items-start gap-8">
                    ...
                    <div className="w-full md:w-2/3 space-y-4">
                        ...
                        <div className="flex items-center gap-4">
                            <label className=" font-medium">Purchase Quantity:</label>
                            <input
                                type="number"
                                min="1"
